...
dummyContract :: Contract () Empty Text ()
dummyContract = do
...
--                             h1 <- activateContractWallet (wallet 1) dummyContract
--                             h2 <- activateContractWallet (wallet 2) dummyContract
--                             h3 <- activateContractWallet (wallet 3) dummyContract
--                             h4 <- activateContractWallet (wallet 4) dummyContract
--                             h5 <- activateContractWallet (wallet 5) dummyContract
--                             h6 <- activateContractWallet (wallet 6) dummyContract
--                             void $ Emulator.waitNSlots 1

test :: IO ()
test = runEmulatorTraceIO contractTrace

contractTrace :: EmulatorTrace ()
contractTrace = do
    Extras.logInfo @String "START"
--    h1 <- activateContractWallet (knownWallet 1) dummyContract
--    h2 <- activateContractWallet (knownWallet 2) dummyContract
    tx1 <- payToWallet (knownWallet 1) (knownWallet 2) $ toValue $ lovelaceOf 5000000
    void $ waitNSlots 1
    tx2 <- payToWallet (knownWallet 1) (knownWallet 3) $ toValue $ lovelaceOf 5000000
    void $ waitNSlots 1
    tx3 <- payToWallet (knownWallet 1) (knownWallet 4) $ toValue $ lovelaceOf 5000000
    void $ waitNSlots 1
